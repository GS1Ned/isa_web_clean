...
LATEST="$REPO_ROOT/docs/evidence/generated/_generated/isa_catalogue_latest"
...
latest = os.path.join(repo, "docs/evidence/generated/_generated/isa_catalogue_latest")
