...
required = [
  "os.environ.get("ISA_EVIDENCE_OUT_DIR", "docs/evidence/_generated")/GS1_EFRAG_CATALOGUE.csv",
  "os.environ.get("ISA_EVIDENCE_OUT_DIR", "docs/evidence/_generated")/GS1_EFRAG_CATALOGUE.json",
  "os.environ.get("ISA_EVIDENCE_OUT_DIR", "docs/evidence/_generated")/GS1_EFRAG_CATALOGUE_INDEX.md",
  "os.environ.get("ISA_EVIDENCE_OUT_DIR", "docs/evidence/_generated")/CATALOGUE_ENTRYPOINTS_STATUS.json",
  "os.environ.get("ISA_EVIDENCE_OUT_DIR", "docs/evidence/_generated")/CATALOGUE_ENTRYPOINTS_STATUS.md",
]
