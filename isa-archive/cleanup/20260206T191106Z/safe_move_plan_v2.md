# ISA Repo Cleanup — SAFE Move Plan v2 (generated)
- generated_utc: 2026-02-06T19:14:16Z
- git_head: `7b63169fff199dd7c3d8cdaacfbafb49fb135509`
...
## Move candidates (preview, SAFE v2)
| from | to | bucket |
|---|---|---|
...
| `docs/META_PHASE_COMPLETION_REPORT.md` | `isa-archive/phase-reports/META_PHASE_COMPLETION_REPORT.md` | `phase_reports` |
...
| `docs/PHASE4_OPERATIONAL_READINESS_REPORT.md` | `isa-archive/phase-reports/PHASE4_OPERATIONAL_READINESS_REPORT.md` | `phase_reports` |
...
| `docs/PHASE_3_COMPLETION_REPORT.md` | `isa-archive/phase-reports/PHASE_3_COMPLETION_REPORT.md` | `phase_reports` |
...
| `docs/PIPELINE_VALIDATION_REPORT.md` | `isa-archive/reports/PIPELINE_VALIDATION_REPORT.md` | `reports_and_outputs` |
...
| `docs/PRODUCTION_DEPLOYMENT.md` | `docs/misc/PRODUCTION_DEPLOYMENT.md` | `docs_misc` |
| `docs/PRODUCTION_IMPROVEMENTS_JAN_2026.md` | `docs/misc/PRODUCTION_IMPROVEMENTS_JAN_2026.md` | `docs_misc` |
| `docs/PRODUCTION_READINESS.md` | `docs/misc/PRODUCTION_READINESS.md` | `docs_misc` |
| `docs/QUALITY_BAR.md` | `docs/misc/QUALITY_BAR.md` | `docs_misc` |
