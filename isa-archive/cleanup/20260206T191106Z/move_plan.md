...
| `phase_reports` | 39 |
| `planning_docs` | 33 |
| `reports_and_outputs` | 58 |
| `spec_docs` | 53 |

## Top TODO drivers (from repo_scan.json)
| hits | path |
|---:|---|
| 213 | `docs/spec/TRACEABILITY_MATRIX.csv` |
| 202 | `todo.md` |
| 102 | `server/routers/roadmap-export.ts` |
| 71 | `docs/ISA_VISUAL_BRANDING_ROADMAP.md` |
| 65 | `docs/spec/roadmap-evolution.md` |
| 57 | `docs/ISA_GS1_PRE_EXECUTION_PREPARATION.md` |
| 54 | `docs/ISA_PRODUCT_DIMENSIONS_ANALYSIS.md` |
| 51 | `server/routers/roadmap.ts` |
| 48 | `docs/ISA_IMPLEMENTATION_EXECUTION_PLAN.md` |
| 46 | `docs/API_REFERENCE.md` |
| 44 | `AUDIT_FINDINGS.md` |
| 42 | `./docs/ISA_VISUAL_BRANDING_DEVELOPMENT_PLAN.md` |
| 41 | `docs/ISA_V1_FORMALIZATION_TARGETS.md` |
| 40 | `./client/src/pages/ComplianceRoadmap.tsx` |
| 37 | `docs/spec/ingestion-update-lifecycle.md` |
| 33 | `./docs/gsmp_manual.txt` |
| 28 | `docs/ISA_DEVELOPMENT_ROADMAP_TO_FINAL_PRODUCT.md` |
| 28 | `docs/STATUS.md` |
| 27 | `TIMELINE_VISUALIZATION_SUMMARY.md` |
| 27 | `docs/CHANGELOG_SUMMARY.md` |
| 26 | `docs/ISA_COMPARATIVE_REFACTOR_GATE_PLAN.md` |
| 26 | `docs/ISA_Strategic_Roadmap.md` |
| 26 | `docs/MANUS_BEST_PRACTICES_FOR_ISA.md` |
| 25 | `docs/GITHUB_PROVISIONING_REPORT.md` |
| 24 | `GS1_ARTEFACT_PROCESSING.md` |
| 24 | `server/roadmap-generator.ts` |
| 23 | `docs/ISA_AUTONOMOUS_ROADMAP_V1.md` |
| 23 | `docs/ISA_FUTURE_DEVELOPMENT_PLAN.md` |
| 22 | `docs/GOVERNANCE_PHASE_2_3_REPORT.md` |
| 22 | `docs/ISA_DELIVERY_MODEL.md` |
...
| `ISA_STATUS_REPORT_2025-01-11.md` | `isa-archive/reports/ISA_STATUS_REPORT_2025-01-11.md` | `reports_and_outputs` |
...
| `PHASE_9_CLAIMS_SANITIZATION_REPORT.md` | `isa-archive/reports/PHASE_9_CLAIMS_SANITIZATION_REPORT.md` | `reports_and_outputs` |
| `PHASE_9_COMPLETION_REPORT.md` | `isa-archive/reports/PHASE_9_COMPLETION_REPORT.md` | `reports_and_outputs` |
...
| `client/src/components/ComplianceCoverageChart.tsx` | `isa-archive/reports/ComplianceCoverageChart.tsx` | `reports_and_outputs` |
| `client/src/components/PipelineStatusBanner.tsx` | `docs/planning/PipelineStatusBanner.tsx` | `planning_docs` |
| `client/src/components/ui/aspect-ratio.tsx` | `docs/spec/aspect-ratio.tsx` | `spec_docs` |
| `client/src/lib/regulation-milestones.ts` | `isa-archive/phase-reports/regulation-milestones.ts` | `phase_reports` |
| `client/src/pages/AdvisoryReports.tsx` | `isa-archive/reports/AdvisoryReports.tsx` | `reports_and_outputs` |
| `client/src/pages/AdvisoryTraceability.tsx` | `docs/spec/AdvisoryTraceability.tsx` | `spec_docs` |
| `client/src/pages/ComplianceReport.tsx` | `isa-archive/reports/ComplianceReport.tsx` | `reports_and_outputs` |
| `client/src/pages/ComplianceRoadmap.tsx` | `docs/planning/ComplianceRoadmap.tsx` | `planning_docs` |
| `client/src/pages/EsgTraceability.tsx` | `docs/spec/EsgTraceability.tsx` | `spec_docs` |
| `client/src/pages/GovernanceDocuments.tsx` | `docs/governance/GovernanceDocuments.tsx` | `governance_docs` |
| `client/src/pages/RoadmapCollaboration.tsx` | `docs/planning/RoadmapCollaboration.tsx` | `planning_docs` |
| `client/src/pages/ToolsComplianceRoadmap.tsx` | `docs/planning/ToolsComplianceRoadmap.tsx` | `planning_docs` |
| `client/src/pages/admin/CoverageAnalytics.tsx` | `isa-archive/reports/CoverageAnalytics.tsx` | `reports_and_outputs` |
| `data/gs1_ref_corpus/authoritative_documents_report.md` | `isa-archive/reports/authoritative_documents_report.md` | `reports_and_outputs` |
| `data/metadata/dataset_registry.schema.json` | `docs/spec/dataset_registry.schema.json` | `spec_docs` |
...
| `docs/DAY1_COMPLETION_REPORT.md` | `isa-archive/reports/DAY1_COMPLETION_REPORT.md` | `reports_and_outputs` |
...
| `docs/GOVERNANCE_PHASE_2_3_REPORT.md` | `isa-archive/reports/GOVERNANCE_PHASE_2_3_REPORT.md` | `reports_and_outputs` |
...
| `docs/ISA_NEXT_PHASE_DEVELOPMENT_PLAN.md` | `isa-archive/phase-reports/ISA_NEXT_PHASE_DEVELOPMENT_PLAN.md` | `phase_reports` |
| `docs/ISA_POC_ROADMAP.md` | `docs/planning/ISA_POC_ROADMAP.md` | `planning_docs` |
| `docs/ISA_PRODUCT_DIMENSIONS_ANALYSIS.md` | `docs/misc/ISA_PRODUCT_DIMENSIONS_ANALYSIS.md` | `docs_misc` |
| `docs/ISA_PRODUCT_VISION.md` | `docs/misc/ISA_PRODUCT_VISION.md` | `docs_misc` |
| `docs/ISA_STATUS_SUMMARY_2025-12-19.md` | `docs/planning/ISA_STATUS_SUMMARY_2025-12-19.md` | `planning_docs` |
| `docs/ISA_STRATEGIC_CONTEXT_SYNTHESIS.md` | `docs/misc/ISA_STRATEGIC_CONTEXT_SYNTHESIS.md` | `docs_misc` |
| `docs/ISA_STRATEGIC_DISCOVERY_REPORT.md` | `isa-archive/reports/ISA_STRATEGIC_DISCOVERY_REPORT.md` | `reports_and_outputs` |
| `docs/ISA_STRATEGIC_EVALUATION_QUALITY_MAPPING.md` | `docs/misc/ISA_STRATEGIC_EVALUATION_QUALITY_MAPPING.md` | `docs_misc` |
| `docs/ISA_STRATEGIC_PIVOT_REPORT.md` | `isa-archive/reports/ISA_STRATEGIC_PIVOT_REPORT.md` | `reports_and_outputs` |
| `docs/ISA_Strategic_Insights_from_Reports.md` | `isa-archive/reports/ISA_Strategic_Insights_from_Reports.md` | `reports_and_outputs` |
| `docs/ISA_Strategic_Roadmap.md` | `docs/planning/ISA_Strategic_Roadmap.md` | `planning_docs` |
| `docs/ISA_UX_STRATEGY.md` | `docs/misc/ISA_UX_STRATEGY.md` | `docs_misc` |
| `docs/ISA_V1_CONSISTENCY_FIXES.md` | `docs/misc/ISA_V1_CONSISTENCY_FIXES.md` | `docs_misc` |
| `docs/ISA_V1_FINAL_DELIVERY.md` | `docs/misc/ISA_V1_FINAL_DELIVERY.md` | `docs_misc` |
| `docs/ISA_V1_FORMALIZATION_COMPLETE.md` | `docs/misc/ISA_V1_FORMALIZATION_COMPLETE.md` | `docs_misc` |
| `docs/ISA_V1_FORMALIZATION_TARGETS.md` | `docs/misc/ISA_V1_FORMALIZATION_TARGETS.md` | `docs_misc` |
| `docs/ISA_V1_HARDENING_COMPLETE.md` | `docs/misc/ISA_V1_HARDENING_COMPLETE.md` | `docs_misc` |
| `docs/ISA_V1_LOCK_CHECKSUMS.txt` | `docs/misc/ISA_V1_LOCK_CHECKSUMS.txt` | `docs_misc` |
| `docs/ISA_V1_LOCK_RECORD.md` | `docs/misc/ISA_V1_LOCK_RECORD.md` | `docs_misc` |
...
| `docs/ISA_WORKFLOW_IMPROVEMENTS.md` | `docs/misc/ISA_WORKFLOW_IMPROVEMENTS.md` | `docs_misc` |
| `docs/KNOWN_FAILURE_MODES.md` | `docs/misc/KNOWN_FAILURE_MODES.md` | `docs_misc` |
| `docs/MANUS_BEST_PRACTICES_EXECUTIVE_SUMMARY.md` | `docs/misc/MANUS_BEST_PRACTICES_EXECUTIVE_SUMMARY.md` | `docs_misc` |
| `docs/MANUS_BEST_PRACTICES_FOR_ISA.md` | `docs/misc/MANUS_BEST_PRACTICES_FOR_ISA.md` | `docs_misc` |
| `docs/MANUS_DAY1_EXECUTION_CHECKLIST.md` | `docs/misc/MANUS_DAY1_EXECUTION_CHECKLIST.md` | `docs_misc` |
| `docs/MANUS_EXECUTION_BRIEF.md` | `docs/misc/MANUS_EXECUTION_BRIEF.md` | `docs_misc` |
| `docs/MANUS_OPTIMIZATION_IMPLEMENTATION_SUMMARY.md` | `docs/misc/MANUS_OPTIMIZATION_IMPLEMENTATION_SUMMARY.md` | `docs_misc` |
| `docs/META_PHASE_COMPLETION_REPORT.md` | `isa-archive/reports/META_PHASE_COMPLETION_REPORT.md` | `reports_and_outputs` |
| `docs/META_PHASE_STRATEGIC_EXPLORATION_PLAN.md` | `isa-archive/phase-reports/META_PHASE_STRATEGIC_EXPLORATION_PLAN.md` | `phase_reports` |
| `docs/NEWS_HEALTH_MONITORING.md` | `docs/misc/NEWS_HEALTH_MONITORING.md` | `docs_misc` |
| `docs/NEWS_HUB_MATURITY_ANALYSIS.md` | `docs/misc/NEWS_HUB_MATURITY_ANALYSIS.md` | `docs_misc` |
| `docs/NEWS_PIPELINE.md` | `docs/misc/NEWS_PIPELINE.md` | `docs_misc` |
| `docs/OPERATIONS_RUNBOOK.md` | `docs/misc/OPERATIONS_RUNBOOK.md` | `docs_misc` |
| `docs/PHASE4_OPERATIONAL_READINESS_REPORT.md` | `isa-archive/reports/PHASE4_OPERATIONAL_READINESS_REPORT.md` | `reports_and_outputs` |
| `docs/PHASE_1_RESCORE.md` | `isa-archive/phase-reports/PHASE_1_RESCORE.md` | `phase_reports` |
| `docs/PHASE_2_ADDENDUM.md` | `isa-archive/phase-reports/PHASE_2_ADDENDUM.md` | `phase_reports` |
| `docs/PHASE_2_DESIGN_EVALUATION.md` | `isa-archive/phase-reports/PHASE_2_DESIGN_EVALUATION.md` | `phase_reports` |
| `docs/PHASE_2_DESIGN_PROPOSAL.md` | `isa-archive/phase-reports/PHASE_2_DESIGN_PROPOSAL.md` | `phase_reports` |
| `docs/PHASE_2_RESCORE.md` | `isa-archive/phase-reports/PHASE_2_RESCORE.md` | `phase_reports` |
| `docs/PHASE_3_COMPLETION_REPORT.md` | `isa-archive/reports/PHASE_3_COMPLETION_REPORT.md` | `reports_and_outputs` |
| `docs/PHASE_3_STARTDOCUMENT.md` | `isa-archive/phase-reports/PHASE_3_STARTDOCUMENT.md` | `phase_reports` |
| `docs/PHASE_8.3_INGESTION_WINDOW_COMPLETE.md` | `isa-archive/phase-reports/PHASE_8.3_INGESTION_WINDOW_COMPLETE.md` | `phase_reports` |
| `docs/PHASE_8_1_VERIFICATION.md` | `isa-archive/phase-reports/PHASE_8_1_VERIFICATION.md` | `phase_reports` |
| `docs/PHASE_8_COMPLETE_SUMMARY.md` | `isa-archive/phase-reports/PHASE_8_COMPLETE_SUMMARY.md` | `phase_reports` |
| `docs/PHASE_8_NEWS_HUB_OBSERVABILITY_COMPLETE.md` | `isa-archive/phase-reports/PHASE_8_NEWS_HUB_OBSERVABILITY_COMPLETE.md` | `phase_reports` |
| `docs/PHASE_AB_UX_SUMMARY.md` | `isa-archive/phase-reports/PHASE_AB_UX_SUMMARY.md` | `phase_reports` |
