...
| `config/isa-catalogue/policy.json` | `docs/misc/policy.json` | `other_docs` |
| `ops/cron/.github/workflows/isa-news-cron.yml` | `docs/misc/isa-news-cron.yml` | `other_docs` |
| `ops/cron/00-START-HERE.md` | `docs/misc/00-START-HERE.md` | `other_docs` |
| `ops/cron/README.md` | `docs/misc/README.md` | `other_docs` |
| `ops/cron/cron-job.org-instructions.md` | `docs/misc/cron-job.org-instructions.md` | `other_docs` |
| `ops/cron/curl-test-config.txt` | `docs/misc/curl-test-config.txt` | `other_docs` |
| `ops/cron/curl-test-instructions.md` | `docs/misc/curl-test-instructions.md` | `other_docs` |
| `ops/cron/easycron-instructions.md` | `docs/misc/easycron-instructions.md` | `other_docs` |
| `ops/cron/github-actions-instructions.md` | `docs/misc/github-actions-instructions.md` | `other_docs` |
...
| `docs/evidence/generated/inventory/docs/evidence/generated/inventory/INVENTORY_AFTER.csv` | `isa-archive/phase-reports/docs/evidence/generated/inventory/INVENTORY_AFTER.csv` | `phase_reports` |
| `docs/evidence/generated/inventory/docs/evidence/generated/inventory/INVENTORY_BEFORE.csv` | `isa-archive/phase-reports/docs/evidence/generated/inventory/INVENTORY_BEFORE.csv` | `phase_reports` |
| `docs/evidence/generated/inventory/docs/evidence/generated/inventory/INVENTORY_FINAL.csv` | `isa-archive/phase-reports/docs/evidence/generated/inventory/INVENTORY_FINAL.csv` | `phase_reports` |
