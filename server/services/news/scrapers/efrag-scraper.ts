...
export async function scrapeEFRAGNews(): Promise<EFRAGArticle[]> {
  try {
    ...
    const esrsKeywords = [
      'esrs', 'sustainability reporting', 'csrd', 'implementation guidance',
      'european sustainability reporting', 'disclosure requirement',
      'materiality', 'double materiality', 'value chain',
