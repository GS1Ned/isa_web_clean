...
export async function scrapeEURLexNews(): Promise<EURLexArticle[]> {
  try {
    ...
    const feedUrl = 'https://ec.europa.eu/commission/presscorner/api/documents.rss?pagenumber=0&pagesize=50&language=en';
    ...
    const sustainabilityKeywords = [
      ...
      'green deal', 'taxonomy', 'disclosure'
    ];
    ...
    console.log(`[EUR-Lex Scraper] Filtered to ${articles.length} sustainability articles`);
    return articles;
