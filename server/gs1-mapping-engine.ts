...
import { regulations, gs1Standards, regulationStandardMappings, type Regulation, type GS1Standard } from '../drizzle/schema';
import { eq, sql } from 'drizzle-orm';

/**
 * Keyword mappings: regulation keywords → GS1 standard codes
 */
const KEYWORD_MAPPINGS: Record<string, { standards: string[]; weight: number }> = {
  // Traceability keywords
  'traceability': { standards: ['EPCIS', 'CBV', 'GS1_Track_and_Trace', 'GS1_Origin_Information'], weight: 0.9 },
  'supply chain': { standards: ['EPCIS', 'GLN', 'SSCC', 'GS1_Track_and_Trace'], weight: 0.8 },
  'due diligence': { standards: ['EPCIS', 'GS1_Origin_Information', 'GS1_Track_and_Trace'], weight: 0.9 },
  'provenance': { standards: ['EPCIS', 'GS1_Origin_Information'], weight: 0.9 },
  'origin': { standards: ['GS1_Origin_Information', 'EPCIS'], weight: 0.8 },
  
  // Sustainability keywords
  'sustainability': { standards: ['GS1_Sustainability_Attributes', 'GS1_Circular_Economy_Attributes', 'EPCIS'], weight: 0.9 },
  'environmental': { standards: ['GS1_Sustainability_Attributes', 'GS1_Circular_Economy_Attributes'], weight: 0.8 },
  'carbon': { standards: ['GS1_Sustainability_Attributes'], weight: 0.9 },
  'emissions': { standards: ['GS1_Sustainability_Attributes'], weight: 0.8 },
  'circular economy': { standards: ['GS1_Circular_Economy_Attributes', 'GRAI'], weight: 0.9 },
  'recycling': { standards: ['GS1_Circular_Economy_Attributes', 'GS1_Packaging_Attributes'], weight: 0.8 },
  'reuse': { standards: ['GS1_Circular_Economy_Attributes', 'GRAI'], weight: 0.8 },
  
  // Packaging keywords
  'packaging': { standards: ['GS1_Packaging_Attributes', 'GS1_Net_Content', 'GS1_Circular_Economy_Attributes'], weight: 0.9 },
  'waste': { standards: ['GS1_Packaging_Attributes', 'GS1_Circular_Economy_Attributes'], weight: 0.8 },
  'recyclable': { standards: ['GS1_Packaging_Attributes', 'GS1_Circular_Economy_Attributes'], weight: 0.9 },
  'material composition': { standards: ['GS1_Packaging_Attributes'], weight: 0.9 },
  
  // Product identification keywords
  'product identification': { standards: ['GTIN', 'GS1_Digital_Link', 'GS1_QR_Code'], weight: 0.9 },
  'barcode': { standards: ['GTIN', 'GS1_128', 'GS1_DataMatrix', 'GS1_QR_Code'], weight: 0.8 },
  'unique identifier': { standards: ['GTIN', 'GLN', 'SSCC'], weight: 0.8 },
  
  // Digital Product Passport keywords
  'digital product passport': { standards: ['GS1_Digital_Link', 'GS1_QR_Code', 'GTIN', 'EPCIS'], weight: 1.0 },
  'product information': { standards: ['GS1_Digital_Link', 'GS1_Global_Data_Model', 'GDSN'], weight: 0.7 },
  'consumer information': { standards: ['GS1_Digital_Link', 'GS1_SmartSearch', 'GS1_QR_Code'], weight: 0.8 },
  
  // Deforestation keywords
  'deforestation': { standards: ['EPCIS', 'GS1_Origin_Information', 'GS1_Track_and_Trace'], weight: 1.0 },
  'forest': { standards: ['GS1_Origin_Information', 'EPCIS'], weight: 0.8 },
  'timber': { standards: ['GS1_Origin_Information', 'EPCIS'], weight: 0.9 },
  
  // Reporting keywords
  'reporting': { standards: ['GS1_Sustainability_Attributes', 'GS1_Regulatory_Information', 'EPCIS'], weight: 0.7 },
  'disclosure': { standards: ['GS1_Sustainability_Attributes', 'GS1_Regulatory_Information'], weight: 0.7 },
  'transparency': { standards: ['GS1_Digital_Link', 'GS1_SmartSearch', 'EPCIS'], weight: 0.8 },
  
  // Compliance keywords
  'compliance': { standards: ['GS1_Regulatory_Information', 'GS1_Certification_Information', 'Verified_by_GS1'], weight: 0.8 },
  'certification': { standards: ['GS1_Certification_Information', 'Verified_by_GS1'], weight: 0.9 },
  'verification': { standards: ['Verified_by_GS1', 'GS1_Certification_Information'], weight: 0.9 },
  
  // Data exchange keywords
  'data exchange': { standards: ['GDSN', 'GS1_Global_Data_Model', 'EPCIS'], weight: 0.8 },
  'data synchronization': { standards: ['GDSN', 'GS1_Global_Data_Model'], weight: 0.9 },
 ...
 */
const REGULATION_TYPE_MAPPINGS: Record<string, { standards: string[]; weight: number }> = {
  'CSRD': { standards: ['GS1_Sustainability_Attributes', 'EPCIS', 'GS1_Regulatory_Information'], weight: 0.9 },
  'ESRS': { standards: ['GS1_Sustainability_Attributes', 'EPCIS', 'GS1_Origin_Information'], weight: 0.9 },
  'DPP': { standards: ['GS1_Digital_Link', 'GS1_QR_Code', 'GTIN', 'EPCIS', 'GS1_Circular_Economy_Attributes'], weight: 1.0 },
  'EUDR': { standards: ['EPCIS', 'GS1_Origin_Information', 'GS1_Track_and_Trace'], weight: 1.0 },
  'PPWR': { standards: ['GS1_Packaging_Attributes', 'GS1_Circular_Economy_Attributes', 'GS1_Net_Content'], weight: 1.0 },
  'CSDDD': { standards: ['EPCIS', 'GS1_Origin_Information', 'GS1_Track_and_Trace'], weight: 0.9 },
};
 ...
 */
function getCategoryBonus(regulation: Regulation, standard: GS1Standard): number {
...
function extractKeywords(regulation: Regulation): string[] {
  const text = `${regulation.title} ${regulation.description || ''}`.toLowerCase();
 ...
 */
export async function mapRegulationToStandards(regulationId: number): Promise<MappingResult[]> {
  ...
  for (const standard of allStandards) {
    const relevanceScore = calculateRelevanceScore(regulation, standard, keywordMatches, typeMatch);
    ...
    if (relevanceScore > 0.3) {
      results.push({
        ...
        mappingReason: generateMappingReason(regulation, standard, keywordMatches, typeMatch),
      });
    }
  }
 ...
 */
export async function saveMappings(regulationId: number, mappings: MappingResult[]): Promise<void> {
  const db = await getDb();
  if (!db) throw new Error('Database connection failed');
  
  // Delete existing mappings for this regulation
  await db.delete(regulationStandardMappings).where(eq(regulationStandardMappings.regulationId, regulationId));
 ...
 */
export async function mapAllRegulations(): Promise<{ regulationId: number; mappingsCount: number }[]> {
  const db = await getDb();
  if (!db) throw new Error('Database connection failed');
...
export async function getMappingsForRegulation(regulationId: number) {
  ...
  const mappings = await db
    ...
    .leftJoin(gs1Standards, eq(regulationStandardMappings.standardId, gs1Standards.id))
