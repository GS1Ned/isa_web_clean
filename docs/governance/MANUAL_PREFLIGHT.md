...
- Tier 1 (blocking): `bash scripts/run-ci-tests.sh --report-dir test-results/ci`
- Tier 2 (non-blocking diagnostics): `pnpm vitest run --testNamePattern "\[quarantine\]" --passWithNoTests --reporter=verbose`
