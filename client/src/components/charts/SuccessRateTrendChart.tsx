        ...
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={chartData}>
            ...
            <YAxis 
              ...
              className="text-xs"
              tick={{ fontSize: 11 }}
              label={{ value: 'Success Rate (%)', angle: -90, position: 'insideLeft', style: { fontSize: 11 } }}
            />
            <Tooltip 
              contentStyle={{ 
