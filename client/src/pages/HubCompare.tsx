...
const SAMPLE_REGULATIONS = [
  { id: 1, name: "CSRD (Corporate Sustainability Reporting Directive)", code: "CSRD" },
  { id: 2, name: "ESRS (European Sustainability Reporting Standards)", code: "ESRS" },
  { id: 3, name: "DPP (Digital Product Passport)", code: "DPP" },
  { id: 4, name: "EUDR (EU Deforestation Regulation)", code: "EUDR" },
  { id: 5, name: "PPWR (Packaging and Packaging Waste Regulation)", code: "PPWR" },
  { id: 6, name: "ESPR (Ecodesign for Sustainable Products Regulation)", code: "ESPR" },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-12">
          <Link href="/hub" className="text-sm text-blue-600 hover:text-blue-700 mb-4 inline-block">
            ← Back to Hub
          </Link>
          <h1 className="text-4xl font-bold text-slate-900 mb-4">Regulation Comparison Tool</h1>
          <p className="text-lg text-slate-600">
            Compare two EU ESG regulations to understand overlapping requirements, shared deadlines, and complementary obligations.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <Card className="p-6 border-2 border-slate-200">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Select First Regulation</h3>
          ...
          {/* Right Regulation */}
          <Card className="p-6 border-2 border-slate-200">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Select Second Regulation</h3>
            <div className="space-y-2">
              {SAMPLE_REGULATIONS.map((reg) => (
                <button
                  key={reg.id}
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg p-8 border-2 border-blue-200">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <div className="text-sm text-slate-600 mb-1">Regulation 1</div>
                  <div className="text-2xl font-bold text-slate-900">{reg1.code}</div>
                </div>
                <ArrowRight className="w-8 h-8 text-blue-500" />
                <div className="text-right">
                  <div className="text-sm text-slate-600 mb-1">Regulation 2</div>
                  <div className="text-2xl font-bold text-slate-900">{reg2.code}</div>
                </div>
              </div>
              <p className="text-slate-600">
                Comparing <strong>{reg1.name}</strong> with <strong>{reg2.name}</strong>
              </p>
            </div>
            ...
            <Card className="p-8 border-2 border-green-200 bg-green-50">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Overlapping GS1 Standards</h3>
            ...
            <Card className="p-8 border-2 border-orange-200 bg-orange-50">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Shared Implementation Deadlines</h3>
            ...
            <Card className="p-8 border-2 border-blue-200 bg-blue-50">
              <h3 className="text-xl font-semibold text-slate-900 mb-4">Complementary Requirements</h3>
              <p className="text-lg text-slate-700 leading-relaxed">{comparison.complementary}</p>
            </Card>

            {/* Dependencies */}
            <Card className="p-8 border-2 border-purple-200 bg-purple-50">
              <h3 className="text-xl font-semibold text-slate-900 mb-4">Regulatory Dependencies</h3>
              <p className="text-lg text-slate-700 leading-relaxed">{comparison.dependencies}</p>
            </Card>
        ...
        {!comparison && (
          <Card className="p-12 text-center border-2 border-dashed border-slate-300">
            ...
            <p className="text-lg text-slate-600">Select two regulations to compare their requirements and dependencies.</p>
          </Card>
        )}
      </div>
    </div>
