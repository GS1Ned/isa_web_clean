...
import { Zap, TrendingUp, Calendar, BookOpen, AlertCircle, Search, ArrowRight, Database, Sparkles, Shield, FileText, BarChart3, Target } from "lucide-react";
...
export default function HubHome() {
  const upcomingDeadlines = [
    { date: "Jan 1, 2025", regulation: "CSRD", description: "Large companies first reporting period begins", severity: "critical" },
    { date: "Jun 30, 2025", regulation: "EUDR", description: "Deforestation due diligence mandatory for all operators", severity: "critical" },
    { date: "Dec 31, 2026", regulation: "ESRS", description: "First full ESRS disclosure reports due", severity: "important" },
  ];

  const quickStartUseCases = [
    {
      title: "CSRD Compliance Planning",
      description: "Map CSRD requirements to ESRS datapoints and identify applicable GS1 standards",
      icon: Target,
    ...
    },
    {
      ...
      description: "Identify deforestation risks and map GS1 traceability standards to EUDR requirements",
      icon: Shield,
    ...
    },
    {
      ...
      description: "Browse 1,184 ESRS datapoints and understand which apply to your organization",
      icon: FileText,
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <nav className="sticky top-0 z-50 border-b border-border bg-card/95 backdrop-blur">
        <div className="container flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition">
            ...
            <span className="font-bold text-lg text-foreground">ISA ESG Hub</span>
          </Link>
          <div className="flex items-center gap-4">
            <Link href="/hub/regulations" className="text-sm text-muted-foreground hover:text-foreground transition">
              Regulations
            </Link>
            <Link href="/hub/esrs-datapoints" className="text-sm text-muted-foreground hover:text-foreground transition">
              ESRS Datapoints
            </Link>
        ...
        <div className="container">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex items-center justify-center mb-6">
              <Badge variant="outline" className="px-4 py-2 text-sm font-medium bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300">
            ...
            <p className="text-xl text-center text-muted-foreground leading-relaxed mb-8 max-w-3xl mx-auto">
              The only platform combining <strong>38 EU sustainability regulations</strong>, <strong>1,184 ESRS datapoints</strong>, and <strong>60 GS1 standards</strong> with <strong>450 AI-powered mappings</strong>. Auto-updated daily from official sources.
            </p>

            {/* Statistics Showcase */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
              <div className="text-center p-4 rounded-lg bg-white/50 dark:bg-gray-900/50 border border-border">
                <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-1">38</div>
                <div className="text-sm text-muted-foreground">EU Regulations</div>
              </div>
              <div className="text-center p-4 rounded-lg bg-white/50 dark:bg-gray-900/50 border border-border">
                <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-1">1,184</div>
                <div className="text-sm text-muted-foreground">ESRS Datapoints</div>
              </div>
              <div className="text-center p-4 rounded-lg bg-white/50 dark:bg-gray-900/50 border border-border">
                <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-1">60</div>
                <div className="text-sm text-muted-foreground">GS1 Standards</div>
              </div>
              <div className="text-center p-4 rounded-lg bg-white/50 dark:bg-gray-900/50 border border-border">
                <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-1">450</div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Choose your compliance challenge and get actionable insights in under 5 minutes
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {quickStartUseCases.map((useCase, idx) => {
              ...
              return (
                <Card key={idx} className="hover:border-blue-500 transition-all hover:shadow-lg">
                  <CardHeader>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-sm">
                  Browse 38 EU regulations with full-text search, filtering, and impact analysis
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="text-base">ESRS Datapoints Library</CardTitle>
                <CardDescription className="text-sm">
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="text-base">GS1 Standards Catalog</CardTitle>
                <CardDescription className="text-sm">
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="text-base">Regulatory News Feed</CardTitle>
                <CardDescription className="text-sm">
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="text-base">Regulation Comparison</CardTitle>
                <CardDescription className="text-sm">
      ...
      <section className="py-16 border-b border-border">
        <div className="container">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-2">Critical Upcoming Deadlines</h2>
              <p className="text-muted-foreground">Stay ahead of enforcement dates and reporting windows</p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {upcomingDeadlines.map((deadline, idx) => (
              <Card key={idx} className={`border-l-4 ${deadline.severity === 'critical' ? 'border-l-red-500' : 'border-l-yellow-500'}`}>
                <CardHeader>
                  <div className="flex items-start gap-3">
                    <Calendar className={`w-5 h-5 flex-shrink-0 mt-1 ${deadline.severity === 'critical' ? 'text-red-500' : 'text-yellow-500'}`} />
                    <div className="flex-1">
                      <div className="text-sm font-medium text-muted-foreground mb-1">{deadline.date}</div>
                      <CardTitle className="text-lg mb-2">{deadline.regulation}</CardTitle>
      ...
      <section className="py-16 border-b border-border bg-muted/30">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-3">Trusted Data Sources</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              All data sourced from official EU and industry authorities, auto-updated daily
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-foreground mb-2">CELLAR Database</h3>
              <p className="text-sm text-muted-foreground">
                Official EU legal database with monthly auto-sync for regulation updates
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Official ESRS datapoints from European Financial Reporting Advisory Group
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-foreground mb-2">GS1 Standards</h3>
              <p className="text-sm text-muted-foreground">
                Curated catalog from GS1 Netherlands and global standards documentation
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-b from-blue-50 to-transparent dark:from-blue-950/20">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-foreground mb-4">Ready to Transform Your ESG Compliance?</h2>
            <p className="text-xl text-muted-foreground mb-8">
              Join GS1 Netherlands network members using ISA ESG Hub to save hours of manual research and stay ahead of regulatory changes.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><Link href="/hub/compare" className="hover:text-foreground transition">Comparison Tool</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><Link href="/hub/calendar" className="hover:text-foreground transition">Compliance Calendar</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link href="/about" className="hover:text-foreground transition">About ISA</Link></li>
                <li><Link href="/contact" className="hover:text-foreground transition">Contact</Link></li>
                <li><Link href="/" className="hover:text-foreground transition">Back to ISA Home</Link></li>
              </ul>
            </div>
          </div>
          <div className="text-center text-sm text-muted-foreground border-t border-border pt-8">
            <p>&copy; 2025 Intelligent Standards Architect - ESG Hub. Data updated daily from official sources.</p>
          </div>
        </div>
      </footer>
    </div>
