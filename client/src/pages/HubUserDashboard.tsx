...
import { Bell, Bookmark, Trash2, Edit2, Plus, Calendar, AlertCircle, CheckCircle } from "lucide-react";
...
const SAMPLE_ALERTS = [
  {
    ...
    message: "Companies must implement due diligence systems for deforestation-free commodities.",
    date: "Nov 28, 2024",
    read: false,
  },
  {
    ...
    message: "EFRAG releases comprehensive guidance on CSRD reporting requirements.",
    date: "Nov 25, 2024",
    read: false,
  },
  {
    ...
    message: "Customs authorities begin enforcement of EUDR due diligence requirements.",
    date: "Nov 20, 2024",
    read: true,
  },
];
...
export default function HubUserDashboard() {
  ...
  const [savedRegulations, setSavedRegulations] = useState(SAMPLE_SAVED_REGULATIONS);
      ...
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center max-w-md">
          ...
          <p className="text-muted-foreground mb-6">
            Please sign in to access your personalized regulatory dashboard and alerts.
          </p>
          <Link href="/">
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1">
        <div className="container py-8">
          {/* Header */}
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-foreground mb-2">Your Regulatory Dashboard</h2>
            <p className="text-muted-foreground">
              Track saved regulations, manage alerts, and stay updated on compliance deadlines.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <div className="card-elevated p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground mb-1">Saved Regulations</p>
                  <p className="text-3xl font-bold text-foreground">{savedRegulations.length}</p>
                </div>
            ...
            <div className="card-elevated p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground mb-1">Alerts Enabled</p>
            ...
            <div className="space-y-4">
              {savedRegulations.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-4">No saved regulations yet.</p>
                ...
                savedRegulations.map((reg) => (
                  <div key={reg.id} className="card-elevated p-6 hover:border-accent transition">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        <h3 className="text-lg font-semibold text-foreground mb-2">{reg.title}</h3>
                      ...
                      <div className="flex gap-2 flex-shrink-0">
                        <button
                          ...
                          title={reg.alertsEnabled ? "Alerts enabled" : "Alerts disabled"}
                        >
