...
import { Zap, Mail, Phone, MapPin, Send, CheckCircle2, AlertCircle, Loader2 } from "lucide-react";
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Have questions about ISA? Want to schedule a demo? We'd love to hear from you.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@isa.ai" className="text-accent hover:text-accent/80 transition">
                        hello@isa.ai
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+33123456789" className="text-accent hover:text-accent/80 transition">
                        +33 (0)1 23 45 67 89
                      </a>
                    </div>
                  </div>
              ...
              <div className="bg-card rounded-lg p-6 border border-border">
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="/how-it-works" className="text-accent hover:text-accent/80 transition text-sm">
                      How It Works
                    </Link>
                  </li>
                  <li>
                    <Link href="/features" className="text-accent hover:text-accent/80 transition text-sm">
                      Features & Roadmap
                    </Link>
                  </li>
                  <li>
                    <Link href="/use-cases" className="text-accent hover:text-accent/80 transition text-sm">
                      Use Cases
                    </Link>
                  </li>
                  <li>
                    <Link href="/dashboard" className="text-accent hover:text-accent/80 transition text-sm">
                      Demo Dashboard
                    </Link>
                  </li>
                </ul>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">{submitResult.message}</p>
                      </div>
                    </div>
                  </div>
                )}
