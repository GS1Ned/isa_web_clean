  ...
  const useCases = [
    {
      ...
      icon: Users,
      description: "Help clients map compliance requirements to supply chain standards",
      scenario:
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="py-20 md:py-32 bg-gradient-to-b from-accent/5 to-transparent">
        <div className="container">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-6">Use Cases</h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              See how different stakeholders use ISA to accelerate compliance and standards mapping.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {metrics.map((metric) => (
              <div key={metric.label} className="text-center">
                ...
                <p className="font-medium text-foreground text-sm mb-1">{metric.label}</p>
        ...
        <div className="container">
          <div className="space-y-16">
            {useCases.map((useCase, index) => {
              ...
              return (
                <div key={useCase.role} className="grid lg:grid-cols-2 gap-12 items-center">
                  <div className={index % 2 === 1 ? "order-2" : ""}>
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h2 className="text-3xl font-bold text-foreground">{useCase.role}</h2>
                    </div>
                        ...
                        {useCase.benefits.map((benefit) => (
                          <li key={benefit} className="flex items-start gap-3">
                            <CheckCircle2 className={`w-5 h-5 flex-shrink-0 mt-0.5 ${
                              useCase.color === "accent" ? "text-accent" : "text-secondary"
                            }`} />
                    ...
                    <div className={`mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-lg ${
                      ...
                      <span className="font-medium text-sm">{useCase.timeSaving} faster</span>
                    </div>
                  </div>
                  ...
                  <div className={index % 2 === 1 ? "order-1" : ""}>
                    <div className={`bg-gradient-to-br ${
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-muted-foreground font-medium">{useCase.role}</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 bg-card border-t border-border">
        <div className="container">
          <h2 className="text-4xl font-bold text-foreground mb-12 text-center">Return on Investment</h2>
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-5xl font-bold text-accent mb-3">40-60%</div>
              <p className="text-muted-foreground">Cost reduction per compliance project</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Payback period for typical enterprise</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-background">
        <div className="container text-center">
          <h2 className="text-4xl font-bold text-foreground mb-6">See ISA in Action</h2>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Explore the demo dashboard to see how ISA maps regulations to GS1 standards in real-time.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/how-it-works" className="inline-flex items-center justify-center px-8 py-4 rounded-lg border border-border text-foreground font-medium text-lg hover:border-accent transition">
              Learn How It Works
            </Link>
          </div>
        </div>
